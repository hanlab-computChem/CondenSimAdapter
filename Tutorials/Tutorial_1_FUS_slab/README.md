...
#   - calvados: CALVADOS force field (auto-selects CALVADOS2/3 based on components)
#   - hps: HPS-Urry model
#   - cocomo: COCOMO2
...
simulation:
  steps: 1000000    # 10.0 ns (1 step = 10 fs)
...
Loading checkpoint from: /mnt/hdd1/home/tianxj/code/ms2main/CondenSimAdapter/CondenSimAdapter/extern/ms2_cg2all/model/CalphaBasedModel.ckpt
  ...
  Backmap completed
  Input PDB: FUS_LC_CG
  Output PDB: FUS_LC_backmap/backmapped.pdb
...
============================================================
  ...
  [3/4] OpenMM softcore minimization (3 stages) ...
    ...
    Generated step3_final.pdb
  [4/4] Adding explicit solvent ...
    Water model: tip4p2005s
    Solvent box added
    Ions added at 0.15 M
    Final structure: minimize_final_solvated.pdb
    Final topology: topol.top

  Minimization completed
  Input PDB:  FUS_LC_backmap/backmapped.pdb
  Output dir: FUS_LC_minimize
