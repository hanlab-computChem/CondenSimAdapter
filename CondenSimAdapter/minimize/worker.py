...
Examples:
    ...
    parser.add_argument("-g", "--gpu-id", type=int, default=0, help="GPU device index (default: 0)")
    parser.add_argument(
        "--iter", type=int, default=5000, help="Max iterations per stage (default: 5000)"
    )
    parser.add_argument(
        "--tolerance",
        type=float,
    ...
    parser.add_argument(
        "--ff-name", default="amber99sb-ildn", help="pdb2gmx force-field name (informational)"
    )
    parser.add_argument(
        "--gb-model",
        default="OBC2",
    ...
    parser.add_argument(
        "--salt-conc", type=float, default=0.15, help="Salt concentration in M (default: 0.15)"
    )
    parser.add_argument(
        "--cutoff", type=float, default=2.0, help="Nonbonded cutoff in nm (default: 2.0)"
    )
